...
- **app_stats** - The [statistics for the application server]() 
- **db_stats** - The [statistics for the database server]() 
...
- **owner_name** - The owner name for the bill run
...
- **user\_package_billed** - The total number of user packages billed
- **user\_package\_bill_rate** - The user package bill rate, calculated for every collection interval stored in a float array
